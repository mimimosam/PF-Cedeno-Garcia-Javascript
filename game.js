...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image(
      "bg",
      "https://res.cloudinary.com/drpr6euyz/image/upload/v1711205355/Game%20Javascript/background1_tn8azl.png"
    );
    this.load.image(
      "player",
      "https://res.cloudinary.com/drpr6euyz/image/upload/v1711205385/Game%20Javascript/mushroomp_qzv7mc.png"
    );
    this.load.image(
      "coin",
      "https://res.cloudinary.com/drpr6euyz/image/upload/v1711205380/Game%20Javascript/coin_gnxd1n.png"
    );
    this.load.image(
      "money",
      "https://res.cloudinary.com/drpr6euyz/image/upload/v1711205390/Game%20Javascript/money_opvk9c.png"
    );
  }
  ...
  create() {
    ...
    this.player = this.physics.add
      .image(sizes.width - 300, sizes.height - 100, "player")
      .setOrigin(0, 0);
